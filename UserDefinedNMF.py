...
class UserDefinedNMF:
    ...
    def __init__(self, n_factors=15, n_epochs=30, reg_pu=0.12, reg_qi=0.12, reg_bu=0.04, reg_bi=0.02, lr_bu=0.01, lr_bi=0.01, learning_rate=0.01, user_id_map=None, item_id_map=None):
    ...
    def test(self, testset):
        ...
        for u, i, r in testset:
            try:
                ...
                if u_mapped is None or i_mapped is None: #user_id_map and item_id_map not defined
